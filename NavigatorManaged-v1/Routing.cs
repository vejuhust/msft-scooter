...
namespace NavigatorManaged
{
    ...
    {
        private static readonly string key = "As-Xme5h3WPlxHWR8cuncv1xPVLwVr-g0SNUgdBKAAz3H9krqehnKiPosfJBsRcD";
        ...
        public static void ApplyOffset(string latitude, string longitude, out string latitudewithoffset, out string longitudewithoffset)
        {
            ...
            try
            {
                ...
                longitudewithoffset = root.GetElementsByTagName(@"ResourceSets")[0].ChildNodes[0].ChildNodes[1].ChildNodes[0].ChildNodes[1].InnerText;
            }
            catch (Exception e)
            {
